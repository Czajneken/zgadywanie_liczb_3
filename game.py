...
HTML_START = """
    ...
    <html lang="en">
        ...
        <body>
            "Think about a number in range 0-1000 and I'll guess it in max. 10 tries!"<br>
            "Press 'too small' if my number is smaller than yours,
            'too big' if my number is bigger or 'you won' if I guessed it!"
